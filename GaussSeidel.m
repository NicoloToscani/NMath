function [x,e,i,flag] = GaussSeidel(A,b,x0,toll,n_max)
% Input: 
%        A      matrice quadrata.
...
% Nel metodo di GaussSeidel abbiamo M = D + E e N = -F.
% Svolgo il procedimento con il metodo matriciale.
% x_k+1 = Px_k + q.
% P = (D - E)^-1 * F e q = (D-E)^-1 * b.
...
% Inversa di D-E. Mi serve per calcolare la matrice di iterazione.
inv_DE = inv(D-E);
